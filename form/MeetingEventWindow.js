 ...
 */
Ext.define('Org.Silv.form.MeetingEventWindow', {
    ...
    titleTextEdit: 'Редактировать встречу',
    width: 600,
    labelWidth: 65,
    detailsLinkText: 'Edit Details...',
    savingMessage: 'Saving changes...',
    ...
    getFormItemConfigs: function() {
        var items = [{
            ...
            xtype: 'textfield',
            itemId: this.id + '-personName',
            name: Extensible.calendar.data.EventMappings.PersonName.name,
            fieldLabel: this.personNameLabelText,
            anchor: '100%'
        },{
            xtype: 'textarea',
    ...
    initRefs: function() {
		...
		this.personNameField = this.down('#' + this.id + '-personName');
